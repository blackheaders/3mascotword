...
function startAnimationTreatments() {
    ...
    TIMEOUTS.push(setTimeout(() => {
        ...
        threadMethodsSpritesheet.setAttribute('animation', 'property: material.opacity; to: 1; dur: 300; delay: 2500;')
        ...
        fillerMethodsSpritesheet.setAttribute('animation', 'property: material.opacity; to: 1; dur: 300; delay: 3500;')
...
function showTestimonials() {
    ...
    TIMEOUTS.push(setTimeout(() => {
        ...
        needle.setAttribute('position', '-0.5 -0.25 0.15')
        audioElement.play()
        ...
        needle.setAttribute('animation__1', 'property: position; to: -0.235 -0.195 0.02; dur: 1000;delay:8500;')

        needle.setAttribute('animation__2', 'property: position;from: -0.235 -0.195 0.02; to: -0.295 -0.2865 0.02; dur: 1200;delay:9500;')
